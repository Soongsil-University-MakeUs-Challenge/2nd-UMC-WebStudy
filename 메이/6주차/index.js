...
const commentItemTemplate = (newComment) => { 
	...
	<li class="commentItem">
		<img src="https://yt3.ggpht.com/yti/APfAmoHsaImoUN9daxfab7R9D14L6OwEZBzkLJgtjQ=s88-c-k-c0x00ffffff-no-rj-mo"  class="profileImg" />
		<div>
			<p id="commentName">박미영</p>
			<p>${newComment}</p>
			<div class="flex">
...
//const newComment = commentItemTemplate('안녕하세요');
